...
function getVisualizedMesh( linearData, year, countries, exportCategories, importCategories ){
	...
	uniforms = {
		...
		texture:   { type: "t", value: 0, texture: THREE.ImageUtils.loadTexture( "./static/images/particleA.png" ) },
	};
	...
	var particleGraphic = THREE.ImageUtils.loadTexture("./static/images/map_mask.png");
    ...
    var materialsz = new THREE.MeshBasicMaterial( { color: 0xffff00 } );
	var pSystem = new THREE.ParticleSystem( particlesGeo, materialsz /*shaderMaterial*/ );
