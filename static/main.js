/*main must import all those intial dependencies */
//import {DetectorObj} from './Detector'
//import './Tween'




//export default function js(document , window){
/*let THREE = require('three')
console.log(THREE)
let jQuery = require('jquery')
let jqueryui = require('jquery-ui')
//let Detector = DetectorObj() 
let dat = require('dat.gui')
let threeKeyboardState = require('./THREEx.KeyboardState')
let windowResize = require('./THREEx.WindowResize')
let stats = require('./Stats')
let requestAnimationFrame = require('./RequestAnimationFrame')
let shadersExtra = require('./ShaderExtras')
let rgbColor = require('rgbcolor')
let stackblur = require('stackblur')
let canvg = require('./canvg')
let innersvg = require('./innersvg')
let util = require('./util')
let mouseKeyboard = require('./mousekeyboard')
let datguicontrol = require('./datguicontrol')
let dataloading = require('./dataloading')
let camerastates = require('./camerastates')
let geopins = require('./geopins')
let visualize = require('./visualize')
let visualizelines = require('./visualize-lines')
let makers = require('./makers')
let svgtoy = require('./svgtoy')
let d3 = require('d3')
let uicontrols = require('./ui.controls.js')*/

console.log('main.js en ejecución...')
...
var isoFile = './static/data/country_iso3166.json';
var latlonFile = './static/data/country_lat_lon.json';
...
function start( e ){	
   ...
   console.log('entre a start')
	if ( ! Detector.webgl ) {
		...
		mapIndexedImage.src = './static/images/map_indexed.png';
		mapIndexedImage.onload = function() {
			mapOutlineImage = new Image();
			mapOutlineImage.src = './static/images/map_outline.png';
							...
							function(){										
								loadContentData(								
									function(){																	
										initScene();
										animate();
                                      console.log('entreeeeeeeee A TODO!!')
									}
								);														
							}
						);
...
function initScene() {
    ...
    //worldCanvas = THREE.ImageUtils.loadTexture("./static/images/map.png");
     var mapGraphic = new THREE.Texture(mapImage);//THREE.ImageUtils.loadTexture("images/map.png");
	 ...
	 const backMat = new THREE.MeshBasicMaterial(
		{
		    ...
		    shininess: 	10, 
			specular: 	0x333333,
            /*map: 		new THREE.TextureLoader().load("./static/images/map.png"),
		    lightMap: 	mapGraphic,*/
            wireframe: true
		}
	);		
   ...
   // HERE IT'S THE FUCKING PROBLEM ON NEXT!!! => shaderMaterial 
   // on visualize.js is the same thing! =>  shaderMaterial
    var materialsz = new THREE.MeshBasicMaterial( { color: 0xffffFF} );
	sphere = new THREE.Mesh( new THREE.SphereGeometry( 100, 40, 40 ), backMat/*shaderMaterial*/ );				
